...
def main():
    ...
    btn1 =Button(root,text="ROCK",font="times 20 bold", command=lambda:play("rock"),fg="#4267B2",padx=20,pady=15)
    btn1.place(x=100,y=400)
    btn2 =Button(root, text="PAPER",font="times 20 bold", command=lambda:play("paper"),fg="#4267B2",padx=20,pady=15)
    btn2.place(x=600,y=400)
    btn3=Button(root, text="SCISSOR",font="times 20 bold", command=lambda:play("scissor"),fg="#4267B2",padx=20,pady=15)
